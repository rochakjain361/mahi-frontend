import { Button, Container, ThemeProvider, Typography } from '@material-ui/core'
    ...
    <Container className={classes.root}>
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.mainDiv}>
          ...
          <div className={classes.subtitle}>Volunteer reaches out</div>
          <Typography className={classes.subcontent}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ultrices et
            pulvinar in mauris ut risus.
          </Typography>
          <div className={classes.subtitle}>Resolved Problem</div>
          <Typography className={classes.subcontent}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ultrices et
            pulvinar in mauris ut risus.
          </Typography>
        ...
        <div className={classes.mainDiv}>
          ...
          <div className={classes.subcontent}>
              Mob: +91 9077339077<br/>
              Email: mahi.care123@gmail.com<br/>
          </div>
